...
undesirable \cite{fedorov1996, hooker2009, fedorov1997, Ucinski05,
...
from a coarse grid in $\Omega$ \cite{koval2020, alexanderian2021,
  attia2022, alexanderian2014, alexanderian2016,
...
\item \label{q:generic} \textbf{Is measurement clusterization a
  ...
  expect that measurement clusterization to be a generic phenomenon.
...
\item \label{q:why} \textbf{Why does measurement clusterization
  ...
  those with the highest power spectrum. In practical scenarios, the
  number of locations where the relevant prior eigenvectors are
  significantly large, while other eigenvectors have a power spectrum
  of zero, is limited. Consequently, the clustering of measurements
  arises as a natural consequence of the pigeonhole principle, as
  there are more measurements available than there are locations
