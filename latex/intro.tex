...
assumption of independent Gaussian noise (likelihood) is standard, and
rooted in the central limit theorem, an assumption of Gaussian prior
is merely a matter of convenience. Therefore, we advise practitioners
encountering clusterization to replace Gaussian priors with
non-Gaussian ones \cite{hosseini2017, hosseini2019}, as these are not
only more realistic but also expected to mitigate clusterization.
