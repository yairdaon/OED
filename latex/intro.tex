...
%% Convergence
Given that D-optimal designs suffer from clusterization, it is natural
to ask whether D-optimal designs should be pursued at all. Other
authors have established convergence results for decaying measurement
error \cite{knapik2011}, space-filling measurements
...
posterior uncertainty ellipsoid in $\hilo$ will contract to zero along
every eigenfunction of $\fwd \prcov \fwd^*$. See Section
