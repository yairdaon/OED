...
For the proof of Theorem \ref{thm:char} we require Lemma
\ref{lemma:free}:
...
\begin{figure}
  ...
  \caption{A comparison of the eigenvalues of the pushforward
    ...
    D-optimal design (left) increases precision (equivalently, reduces
    uncertainty) where it is lowest. The sub-optimal design (right)
    does not.}
