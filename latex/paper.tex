...
%% Some open problems to 

%% We two phenomena for a generic inverse problem with unit-norm
%% constraints on obsevations: First, we showed that when model error is
%% present and obsevation noise is small --- sensor clusterization will
%% not occur. In contrast, we saw that when no model error is present ---
%% sensor clusterization is quite generic and poses no obstruction to
%% D-optimality.
