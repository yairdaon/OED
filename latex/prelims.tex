...
the definition of KL divergence:% for an arbitrary prior measure:
$$
...
%% For a linear inverse problem with Gaussian prior and Gaussian
%% noise, a D-optimal design minimizes an expression analogous to the
%% determinant of the posterior covariance operator
