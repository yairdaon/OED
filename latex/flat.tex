...
\item \label{q:why} \textbf{Why does measurement clusterization
  ...
  The connection to Carath\'eodory's Theorem also utilizes the
...
\subsubsection{Clusterization in our generic model}We can gain further insight to clusterization in our generic model,
