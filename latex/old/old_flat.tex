...
posed in the Introduction. \section{D-Optimal Designs Without Model Error}\label{section:vanishing}
...
\sum_{i=1}^m \eta_i &= m 
  ...
  \begin{align*}
    \begin{split}
      \beta_i &= 0\\
\sigma^{2}\lambda_i^{-1} + \eta_i  &= \frac{1}{2\alpha}\end{split}
  \end{align*}
...
&=\frac{m}{k} + \frac{\sigma^2}{k} \sum_{j\in A} \lambda_j^{-1} - \sigma^2 \lambda_i^{-1}.\end{split}
  \end{align}
\end{proof}
