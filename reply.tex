...
using them. \ydnote{Corrected, thanks!}
...
\item Page 1, Line 39: "In a frequentist settings" should be changed
  ...
  settings". \ydnote{changed in text}
...
\item Page 4, Line 21: The prior distribution $\mathcal{N}(0,
  ...
  comment. Why must the prior mean be 0? \ydnote{It does not have to
    be, we can subtract the mean. An explanation was added}

\item Page 5, Line 15: Add a comma: "Considering the sum of the error
  terms, it is easy..."  \ydnote{changed in text}
...
\item Page 6, Line 7: Please describe what $\psi$ is in the
  ...
  function. \ydnote{added comment before statment of theorem where
    $\tar$ first appears}
