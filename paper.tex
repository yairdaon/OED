...
eigenvectors $\{\ev_i\}_{i=1}^{\infty}$. First, let us present a lemma:
...
\subsection{Non-Vanishing Model Error}
...
canceled by the presence of a non-zero model error. Since the design
...
direction before it is the largest uncertainty present.
