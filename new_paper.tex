...
prior. Consider a linear model in finite dimensions, with Gaussian
prior and noise. In this model, maximizing the expected information
...
understanding D-optimal designs. In this model, D-optimal design
are solutions of a constrained optimization problem, formulated
...
$\sigma^2$ (see section \ref{section:prelim} and
...
log-determinant of the posterior covariance operator. We will see
...
covariance does not depend on data \cite{Stuart10}. Thus, the plot has
...
Let $\hilp$ and $\hilo$ be seperable Hilbert spaces (the subscripts p
...
the number of measurements we are allowed to take. Observations
...
should be given to (i.e. measurement taken in direction of) the $n$th
